    ...
    <div className="min-h-screen flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h2 className="mt-4 text-lg font-semibold text-foreground">Welcome back</h2>
          <p className="mt-1 text-sm text-muted-foreground">Logging in as <span className="text-primary font-medium">{selectedRole}</span></p>
        </div>
        ...
        <p className="mt-6 text-center text-xs text-muted-foreground">
          Don't have an account? <button onClick={() => navigate("/role-select?mode=signup")} className="text-primary hover:underline">Sign up</button>
        </p>
      </div>
    </div>
  );
